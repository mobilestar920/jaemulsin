        ...
        <main class='main-content bgc-grey-100'>
            <div id='mainContent'>
                <div class="container-fluid">
                    <h4 class="c-grey-900 mT-10 mB-30">{{ Lang::get('localizedStr.title_device_manage') }}</h4>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                                <form style="display: flex">
                                    <h4 class="c-grey-900 mB-20" style="flex: 1 1 auto;">{{ Lang::get('localizedStr.device_list') }}</h4>
                                    <button class="btn btn-danger" type="submit" formaction="{{ route('newdevice') }}" style="margin-bottom: 20px !important;">{{ Lang::get('localizedStr.deivce_new') }}</button>
                                </form>
                                <table id="dataTable" class="table table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ Lang::get('localizedStr.android_id')}}</th>
